...
public class SessaoTest {
	...
	@Test
	public void garanteQueOLugarA1EstaOcupadoEOsLugaresA2EA3EstaoDisponiveis() {
		...
		Sala sala1 = new Sala("sala 1", new BigDecimal("8.5"));
		Sessao sessao = new Sessao(LocalTime.now(), rogueOne, sala1);
