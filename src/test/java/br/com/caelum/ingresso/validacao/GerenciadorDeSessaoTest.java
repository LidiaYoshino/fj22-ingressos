...
public class GerenciadorDeSessaoTest {
	...
	@Test
	public void garateQueNaoDevePermitirSessaoNoMesmoHorario() {
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesIniciandoDentroDeUmaSessaoJAExistente() {
	...
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes() {
		...
		Assert.assertTrue(gerenciador.cabe(new Sessao(LocalTime.parse("13:00:00"), filme1, sala)));
